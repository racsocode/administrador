...
@section('content') 
  ...
  <script type="text/javascript">
    ...
    function seleccionado(){
      ...
      $.ajax({
        url: {{$parent}}, //Url a donde la enviaremos
        ...
        error: function(errors){
          ...
          if(data.message=="OK"){
            ...
            $("#archivos").val(""); 
            ias = $('#thumbnail').imgAreaSelect({ disable:false, x1: 0, y1: 0, x2: 405, y2: 305 ,minWidth:405,minHeight:305 ,aspectRatio:'400:300', instance: true,onSelectChange: preview }); 
          }else{
  ...
  <div id="page-wrapper">
    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <p><a href="{{action('ProductosController@getImgCateg', $parent)}}" class="btn btn-danger ">Cancelar</a></p>

        <legend> Agregar Imagen al producto</legend>    
        <div id="subir">
        ...
        <div id="create_thumb">
            <img src="" style="border: 1px solid #000;float: left; margin-right: 10px;" id="thumbnail" alt="Create Thumbnail" />                            
            <br style="clear:both;"/>
            <form name="ajaxform" id="ajaxform" action="{{$prod}}" method="POST">
